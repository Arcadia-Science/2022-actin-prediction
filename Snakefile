...
rule all:
    input:
        expand("outputs/shared_feature_residues/1_shared_residue_information/{query_protein}_{feature}.tsv", query_protein = config["query_protein"], feature = config["features"]),
        expand("outputs/shared_feature_residues/2_shared_residue_summaries/{query_protein}_{feature}.tsv", query_protein = config["query_protein"], feature = config["features"])
...
rule calculate_shared_feature_residues:
    ...
    input: 
        ...
        mafft_map = "query_proteins/{query_protein}.fasta.map",
    output:
        df="outputs/shared_feature_residues/1_shared_residue_information/{query_protein}_{feature}.tsv",
        df_summary="outputs/shared_feature_residues/2_shared_residue_summaries/{query_protein}_{feature}.tsv"
